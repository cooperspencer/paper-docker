...
ENV PAPER_CI_URL=https://api.papermc.io/v2/projects/paper/versions/1.21.4/builds/139/downloads/paper-1.21.4-139.jar
ENV RCON_URL=https://github.com/itzg/rcon-cli/releases/download/1.6.10/rcon-cli_1.6.10_linux_${TARGETARCH}.tar.gz
