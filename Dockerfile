...
ENV PAPERSPIGOT_CI_URL=https://papermc.io/api/v2/projects/paper/versions/1.20.2/builds/299/downloads/paper-1.20.2-299.jar
ENV RCON_URL=https://github.com/itzg/rcon-cli/releases/download/1.6.3/rcon-cli_1.6.3_linux_${TARGETARCH}.tar.gz
