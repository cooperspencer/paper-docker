...
ENV PAPER_CI_URL=https://api.papermc.io/v2/projects/paper/versions/1.21.5/builds/104/downloads/paper-1.21.5-104.jar
ENV RCON_URL=https://github.com/itzg/rcon-cli/releases/download/1.7.0/rcon-cli_1.7.0_linux_${TARGETARCH}.tar.gz
