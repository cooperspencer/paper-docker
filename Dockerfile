...
ENV PAPER_CI_URL=https://api.papermc.io/v2/projects/paper/versions/1.21.11-pre4/builds/10/downloads/paper-1.21.11-pre4-10.jar
ENV RCON_URL=https://github.com/itzg/rcon-cli/releases/download/1.7.3/rcon-cli_1.7.3_linux_${TARGETARCH}.tar.gz
